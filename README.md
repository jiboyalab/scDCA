...
| P76_malignant_cell_states_gsva_mat.txt  | The activity scores calculated by us for 14 functional state in malignant cells of patient P76, which 14 functional state signatures of malignant cells were obtained from the [CancerSEA](http://biocc.hrbmu.edu.cn/CancerSEA/)|
| Test_data_malignant_cell_states_gsva_mat.txt  | The activity scores calculated by us for 14 functional state in malignant cells of test data, which 14 functional state signatures of malignant cells were obtained from the [CancerSEA](http://biocc.hrbmu.edu.cn/CancerSEA/)|
